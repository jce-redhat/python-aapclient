...
def _format_application_data(application_data: Dict[str, Any], use_utc: bool = False, output_format: str = 'table') -> Dict[str, Any]:
    ...
    data['Skip Authorization'] = format_value_for_output(application_data.get('skip_authorization', False), 'skip_authorization', output_format)
...
@click.option('--grant-type', type=click.Choice(['authorization-code', 'password']), required=True, help='OAuth authorization grant type')
...
@create_command
def create_application(console, name, organization, client_type, grant_type, description, redirect_uris, skip_authorization):
...
@click.option('--grant-type', type=click.Choice(['authorization-code', 'password']), help='New OAuth authorization grant type')
...
@common_options
@update_command
def set_application(console, output_format, utc, application_name, id, new_name, description, organization, client_type, grant_type, redirect_uris, skip_authorization):
