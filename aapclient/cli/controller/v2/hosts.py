...
@list_command(
    default_limit=20,
    sort_fields=['id', 'name', 'inventory', 'enabled', 'created', 'modified'],
    default_sort='id'
)
...
@optgroup.group('Host State', cls=MutuallyExclusiveOptionGroup,
                help='Control host enabled/disabled state')
...
@list_command(
    default_limit=20,
    sort_fields=['id', 'hostname', 'first_automation', 'last_automation'],
    default_sort='id'
)
