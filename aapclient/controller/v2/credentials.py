...
from aapclient.common.functions import resolve_credential_name, resolve_organization_name, format_datetime
...
def list_credentials(
    console, output_format, utc, limit, offset, organization, credential_type, show_all, sort_by, reverse
):
    """List credentials."""
    ...
    try:
        ...
        for credential in credentials:
            ...
            rows.append([str(credential.get("id", "")), credential.get("name", ""), cred_type_name, org_name])
...
def _format_credential_data(
    credential: Dict[str, Any], use_utc: bool = False, output_format: str = "table"
) -> Dict[str, Any]:
